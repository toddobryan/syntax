...
const DartParserGeneratorTrait = require('../dart-parser-generator-trait');
 ...
 */
const DART_LR_PARSER_TEMPLATE = fs.readFileSync(
  `${__dirname}/../templates/lr.template.dart`,
  'utf-8',
);
 ...
 */
export default class LRParserGeneratorDart extends LRParserGeneratorDefault {
